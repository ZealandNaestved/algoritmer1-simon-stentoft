...
public class Data {
    ...
    //Et array med masser af intergers
   ...
   //String array med drengenavne.
    ...
    public static void main(String[] args) {
        randomNumbers(10, 10);
    } //Kalder på randomNumbers metoden

    //For loop, når i er mindre end n-1, i++: Printer
